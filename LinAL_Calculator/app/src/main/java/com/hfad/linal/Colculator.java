...
public class Colculator {
    ...
    //========================================================Gaus
    static String GausMethod(double[][] Matrix) throws NoSolutionExeption, InfSolutionExeption{
        String str = "";
        ...
        for(int i = 0; i < solution.length; i++){
            str = str + String.valueOf(solution[i]) + "\n";
        }
        /*
    ...
    static double[] solve(double[][] A, double[] b) throws NoSolutionExeption, InfSolutionExeption{
        // for square matrix only.  A and b is from row echelon form
    ...
    static double[] notSquare(double[][] A, double[] b) throws NoSolutionExeption, InfSolutionExeption {
    ...
    static double[][] oppositeMatrix(double[][] matrix){
        if (matrix.length == matrix[0].length){
            ...
            if (Double.compare(det,0.0) != 0){ // det != 0
                ...
                //MainActivity.toaster(this,"det == 0");
                return null;
            }
        }else {
            //MainActivity.toaster(,"not square");
            return null;
        }
    }
